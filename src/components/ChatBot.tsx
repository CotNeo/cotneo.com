...
const INITIAL_MESSAGE: Message = {
  role: 'assistant',
  content: "Hello! I'm Furkan's AI assistant. I can answer questions about Furkan, his skills, projects, and experience. What would you like to know? (Note: You can ask up to 3 questions)"
};
